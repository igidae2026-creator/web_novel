...
def _default_story_state(bucket: str | None, outline: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "monetization": {
            ...
            "conversion_risk": 0.0,
            "missing_conversion_signals": [],
        },
        "protagonist_guard": {
            "protagonist_sovereignty": 0.0,
            "protagonist_agency_score": 0.0,
            "secondary_takeover_risk": 0.0,
            "reward_loop_integrity": 0.0,
        },
        "narrative_debt": {
            "narrative_debt_score": 0.0,
            "debt_sources": [],
            "payoff_recovery_rate": 0.0,
            "expansion_friction_risk": 0.0,
        },
        "emotion_wave": {
            "emotion_wave_balance": 0.0,
            "burn_level": 0.0,
            "reset_need": 0.0,
            "fatigue_projection": 0.0,
        },
        "ip_readiness": {
            "ip_readiness": 0.0,
            "webtoon_adaptability": 0.0,
            "franchise_expandability": 0.0,
            "canon_consistency": 0.0,
            "adaptation_scene_density": 0.0,
            "world_expansion_capacity": 0.0,
        },
        "promise_graph": {
            "active_promises": [],
            "resolved_promises": [],
