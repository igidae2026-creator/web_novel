...
Produce web novels that ordinary readers would recognize as top-tier commercial work, not merely readable drafts.
...
Reader-perceived quality requirements:
- strong hook within early chapters
- clear and addictive episode endings
- persuasive protagonist fantasy and emotional payoff
- legible prose with low friction
- genre-fit pacing, stakes, and reward cadence
- character, conflict, and world logic that remain coherent over time

System success means:
- quality is enforced by system structure
- quality is auditable
- quality can be improved by patching modules and rules
